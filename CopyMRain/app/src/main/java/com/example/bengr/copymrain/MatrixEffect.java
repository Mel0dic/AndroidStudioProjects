package com.example.bengr.copymrain;
...
public class MatrixEffect extends View {
    ...
    int fontSize = 20; //font size of the text which will fall
    int columnSize = width/fontSize; //column size ; no of digit required to fill the screen
    int parentWidth;
    String text = "ABCDEFGHIJLMNOPQRSTUVWXYZ01";  // Text which need to be drawn
